...
By default, the denominator for standardized mean differences uses a pooled estimate (square root of the average of the group variances) for ATE and the standard deviation of the treated group for ATT---both standard deviations are computed using the sample before matching. This option can also be manually set with the `s.d.denom` option.
